          ...
          return (
            ...
            >
              ...
              <button
                ...
                disabled={!canDelete}
                className={`mr-1.5 w-5 h-5 rounded-full flex items-center justify-center transition-colors flex-shrink-0
                  ${!canDelete
                    ? 'opacity-25 cursor-not-allowed ' + (isActive ? 'text-brand-200' : 'text-gray-300')
                    : isActive
